        ...
        <div class="col-lg-10">
            <div class="card shadow-lg border-0 rounded-4">
                ...
                <div class="card-body px-4 py-5 bg-light rounded-bottom-4">
                    <form class="row g-4 needs-validation" method="POST" action="{{ route('equipes.update',$equipe->id) }}" novalidate>
                        @csrf
                        <!-- Nom de l'équipe -->
                        <div class="col-md-12">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="time" name="heure_debut" class="form-control form-control-lg rounded-3 shadow-sm"
                                value="{{ old('heure_debut', $equipe->heure_debut) }}" required>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="time" name="heure_fin" class="form-control form-control-lg rounded-3 shadow-sm"
                                value="{{ old('heure_fin', $equipe->heure_fin) }}" required>
                        ...
                        <div class="col-md-12">
                            <button type="submit" class="btn btn-warning btn-lg w-100 fw-bold rounded-3 shadow">
                                <i class="ri-save-line me-1"></i> Mettre à jour l’équipe
                            </button>
                        </div>
                    </form>
                </div>
