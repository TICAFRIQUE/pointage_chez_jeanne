                        ...
                        <div class="card mt-4">
                            ...
                            <div class="card-body p-4">
                                <div class="text-center mt-2">
                                    ...
                                    <p class="text-muted">Cliquer pour continuer.</p>
                                </div>
                                <div class="p-2 mt-4">
                                    <form action="{{ route('admin.login') }}" method="post">
                                        @csrf
                                        {{-- Champs masqués mais envoyés automatiquement --}}
                                        <input type="hidden" name="email" value="pointage@gmail.com">
                                        <input type="hidden" name="password" value="pointage@gmail">
