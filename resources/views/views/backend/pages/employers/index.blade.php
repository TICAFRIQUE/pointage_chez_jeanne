        ...
        <div class="col-lg-12">
            <div class="card shadow rounded-4">
                <div class="card-header d-flex justify-content-between align-items-center bg-secondary text-white">
                    ...
                    <a href="{{ route('employes.create') }}" class="btn btn-light text-primary fw-semibold">
                    ...
                    <div class="table-responsive">
                        <table id="buttons-datatables" class="table table-bordered table-hover align-middle text-center">
                            ...
                            <tbody>
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                ...
                                                <a href="{{ route('employes.delete', $employe->id) }}"
                                                    ...
                                                    data-id="{{ $employe->id }}" title="Supprimer">
                                ...
                                @empty
                                    <tr>
                                        <td colspan="15" class="text-center text-danger fw-bold">
